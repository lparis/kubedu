/*
Copyright 2018 K8sland Training.
...
import (
	...
	workloadv1alpha1 "github.com/k8sland.io/crds/pkg/apis/workload/v1alpha1"
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcilePainter{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &workloadv1alpha1.Painter{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Painter - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &workloadv1alpha1.Painter{},
	})
	if err != nil {
		return err
	}
